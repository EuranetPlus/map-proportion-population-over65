export const config = {
	mapTitle: 'population-over65', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-proportion-population-over65.vercel.app/', // The url provided when deploying the map on Vercel
